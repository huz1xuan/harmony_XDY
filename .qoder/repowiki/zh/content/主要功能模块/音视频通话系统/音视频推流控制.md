...
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L197-L228)
...
Page->>Engine : muteLocalAudioStream(false)开启音频
Page->>Engine : muteLocalVideoStream(是否静音)
Page-->>H5 : native2Js(2006/2007)
else 1015 切换摄像头
...
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L730-L773)
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L867-L872)
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L874-L892)
...
- handleMuteVideo
  - 本地用户：先取消音频静音（避免音频通道未就绪），再根据mute参数决定是否静音视频；若无视图绑定，触发一次重新推流绑定
...
alt 1006 静音视频
Page->>Engine : muteLocalAudioStream(false)必要时先解除音频静音
Page->>Engine : muteLocalVideoStream(是否静音)
Page->>Page : 检查是否已绑定视图
alt 未绑定
Page->>Page : pushStream(uid, true, true, channelId, userRole, userName)
end
Page-->>H5 : native2Js(2006/2007)
else 1007 静音音频
Page->>Engine : muteLocalVideoStream(false)必要时先解除视频静音
...
**图表来源**
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L730-L773)
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L775-L805)
...
**图表来源**
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L1140-L1167)
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L1225-L1234)
...
**图表来源**
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L264-L268)
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L363-L424)

**章节来源**
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L264-L268)
- [Index.ets](file://entry/src/main/ets/pages/Index.ets#L363-L424)
- [index.d.ts](file://package/src/main/cpp/types/libagora_rtc_sdk/index.d.ts#L108-L122)
...
## 结论
本方案通过清晰的消息分发、严格的推流绑定顺序与状态管理，实现了稳定可靠的音视频推流控制。结合角色匹配与视图等待绑定机制，可在不同设备与场景下获得一致的用户体验。建议在生产环境中遵循本文最佳实践，持续监控首帧到达与静音切换的时序，确保音视频质量与稳定性。